---
title: 'PyCasia'
description: 'An open-source python library to work with the CASIA Chinese handwriting database.'
date: 2017-06-21
tags: ['AI and Machine Learning', 'python', 'numpy']
authors: ['lucas']
---
...
[Source](https://github.com/lucaskjaero/PyCasia) · [Site](https://pypi.org/project/Pycasia/)
